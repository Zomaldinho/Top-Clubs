...
club1 = Club(name='Liverpool', description="Liverpool Football Club is a\
 ...
 a record eight League Cups and fifteen FA Community Shields.",
             countryname=country1, countryid=country1, user_id=1)
session.add(club1)
session.commit()
...
club2 = Club(name='Manchester City', description="Manchester City Football\
 ...
 men's team to win the domestic treble.", countryname=country1,
             countryid=country1, user_id=1)
session.add(club2)
session.commit()
...
club3 = Club(name='Chelsea', description="Chelsea Football Club are an English\
 ...
 trophies.\
 Their home ground is Stamford Bridge.", countryname=country1,
             countryid=country1, user_id=1)
session.add(club3)
session.commit()
...
club4 = Club(name='Manchester United', description="Manchester United\
 ...
 and one FIFA Club World Cup", countryname=country1,
             countryid=country1, user_id=1)
session.add(club4)
session.commit()
...
club5 = Club(name='Arsenal', description="Arsenal Football Club is a\
 ...
 Cup Winners'\
 Cup and 1 Inter-Cities Fairs Cup", countryname=country1,
             countryid=country1, user_id=1)
session.add(club5)
session.commit()
...
club1 = Club(name='Real Madrid', description="Real Madrid, is a Spanish\
 ...
 football, they have achieved a record seven club world championships.",
             countryname=country2, countryid=country2, user_id=1)
session.add(club1)
session.commit()
...
club2 = Club(name='Barcelona', description="Founded in 1899 by a group\
 ...
 Cup, and 3\
 FIFA Club World Cup.", countryname=country2,
             countryid=country2, user_id=1)
session.add(club2)
session.commit()
...
club1 = Club(name='Bayern Munich', description="FC Bayern, is a German\
 ...
 FC Nurnberg, as well as with Borussia Dortmund since the mid 1990s",
             countryname=country3, countryid=country3, user_id=1)
session.add(club1)
session.commit()
...
club3 = Club(name='FC Schalke 04', description="FC Schalke 04 is a\
 ...
 as the first\
 German club to win a cup double in 1937.", countryname=country3,
             countryid=country3, user_id=1)
session.add(club3)
session.commit()

'#Italy'
country4 = Country(name='Italy')
...
club1 = Club(name='Juventus', description="Juve  is an Italian professional\
 ...
 national record of one UEFA Intertoto Cup.", countryname=country4,
             countryid=country4, user_id=1)
session.add(club1)
session.commit()
...
club2 = Club(name='A.S. Roma', description="A.S. Roma is an Italian\
 ...
 runners up in the 1984 European Cup and the 1991 UEFA Cup.",
             countryname=country4, countryid=country4, user_id=1)
session.add(club2)
session.commit()
...
club3 = Club(name='A.C. Milan', description="Milan, is a professional\
 ...
 seven.", countryname=country4, countryid=country4, user_id=1)
session.add(club3)
session.commit()

'#France'
country5 = Country(name='France')
...
club1 = Club(name='Paris Saint-Germain', description="PSG, is a French\
 ...
 supported teams in the world.", countryname=country5,
             countryid=country5, user_id=1)
session.add(club1)
session.commit()
...
club2 = Club(name='Olympique Lyonnais', description=" The club was formed\
 ...
 France titles and three Ligue 2 titles.", countryname=country5,
             countryid=country5, user_id=1)
session.add(club2)
session.commit()
...
club3 = Club(name='Olympique de Marseille', description=" Marseille, is a\
 ...
 Ligue 1), ten Coupes de France and three Coupes de la Ligue.",
             countryname=country5, countryid=country5, user_id=1)
session.add(club3)
session.commit()

'#Netherlands'
country6 = Country(name='Netherlands')
...
club1 = Club(name='AFC Ajax', description="Ajax, is a Dutch professional\
 ...
 Eredivisie titles and 19 KNVB Cups.", countryname=country6,
             countryid=country6, user_id=1)
session.add(club1)
session.commit()
...
club2 = Club(name='PSV Eindhoven', description="PSV Eindhoven is a sports\
 ...
 and the Johan Cruyff Shield ten times. ", countryname=country6,
             countryid=country6, user_id=1)
session.add(club2)
session.commit()
...
club3 = Club(name='Feyenoord', description="Feyenoord is a Dutch professional\
 ...
 and one Intercontinental Cup.", countryname=country6,
             countryid=country6, user_id=1)
session.add(club3)
session.commit()

'#Brazil'
country7 = Country(name='Brazil')
...
club1 = Club(name='Clube de Regatas do Flamengo', description="Flamengo, is a\
 ...
 3 Copa do Brasil, and a record 35 Campeonato Carioca ",
             countryname=country7, countryid=country7, user_id=1)
session.add(club1)
session.commit()
...
club3 = Club(name='Sociedade Esportiva Palmeiras', description="Palmeiras\
 ...
 titles ", countryname=country7, countryid=country7, user_id=1)
session.add(club3)
session.commit()

'#Egypt'
country8 = Country(name='Egypt')
...
club1 = Club(name='Zamalek SC', description="Zamalek is an Egyptian sports\
 ...
 successful clubs in Africa.", countryname=country8,
             countryid=country8, user_id=1)
session.add(club1)
session.commit()
...
club2 = Club(name='Al Ahly SC', description="Al Ahly, is an Egyptian\
 ...
 Al Ahly has never been relegated to the Egyptian Second Division.",
             countryname=country8, countryid=country8, user_id=1)
session.add(club2)
session.commit()
...
club3 = Club(name='Ismaily SC', description="Ismaily is an Egyptian\
 ...
 generation.", countryname=country8, countryid=country8, user_id=1)
session.add(club3)
session.commit()
